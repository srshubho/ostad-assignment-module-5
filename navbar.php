...
<header
    ...
    <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
        ...
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-semibold text-white" href="/" aria-label="Brand">Role Management System</a>
            <div class="sm:hidden">
                <button type="button"
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                <?php if ($auth["role"] === "admin"): ?>
                    ...
                    <a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="role_management.php">Role
                        Management</a>
                <?php endif; ?>
                <?php if (isset($auth["email"])): ?>
                    <a class="font-medium  sm:py-6" href="profile.php" aria-current="page">Profile</a>
                    <a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="logout.php">Logout </a>
                <?php else: ?>
                    <a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="login.php">Login </a>
                    <a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="register.php">register </a>
